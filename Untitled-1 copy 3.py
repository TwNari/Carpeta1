...
ps = "Lavavajillas $1000 USD"
pss = "Horno de gas o eléctrico $1,000 USD"
print ("Constamos de", pu," (1) , ", pd, " (2), ", pt, " (3), ",pc, " (4), ",pcc, " (5), ",ps, " (6) y ",pss," (7)")
print ("Antes de que nos digas que producto te interesa, debes de saber que solo constamos con 10 en existencia de cada uno")
print("---------------------")
print ("*~(￣▽￣)~* ... LOADING")
print("---------------------")
while True:
    rr = input("¿De qué producto quieres información? ")
    if rr in ["1", "2", "3", "4", "5", "6", "7"]:
        while True:
            if rr == "1":
            ...
            print("---------------------")
            while True:
             rr_cantidad = int(input("Dinos que tanta cantidad de este producto quieres comprar: "))
             if historial[producto] + rr_cantidad > 10:
